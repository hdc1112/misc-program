...
find:
	@find -type f -name "*.java" | xargs grep -in $(key) || true
	@find -type f -name "*.c" | xargs grep -in $(key) || true
	@find -type f -name "*.cpp" | xargs grep -in $(key) || true
	@find -type f -name "*.h" | xargs grep -in $(key) || true
