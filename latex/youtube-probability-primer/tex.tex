...
$Eg(X)=\sum\limits_{y\in g(\mathfrak{X})} y P(g(X)=y) \\
=\sum\limits_{y\in g(\mathfrak{X})} y \sum\limits_{x\in\mathfrak{X}:g(x)=y} p(x) \\
=\sum\limits_{y\in g(\mathfrak{X})} \sum\limits_{x\in\mathfrak{X}:g(x)=y} y p(x) \\
=\sum\limits_{y\in g(\mathfrak{X})} \sum\limits_{x\in\mathfrak{X}:g(x)=y} g(x) p(x) \\
=\sum\limits_{x\in\mathfrak{X}} g(x)p(x)$

\bigbreak
Warning: needs extra time and effort to understand ``expectation rule".
